...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51R3Y8mLORbetGSnGve1LHssaMJfnxYc3hh6G8opZnFZVD9z4II2f8FyO77kjjHb1PFAGba2bW2BspV7yO2Zaoe8W00HhclWZcs');
          _context.prev = 1;
          _context.next = 4;
